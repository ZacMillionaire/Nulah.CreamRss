...
/// <summary>
/// For use with tests that go through the Api - mocks all the same as <see cref="MockHttpMessageHandler"/>
/// </summary>
public sealed class MockAspHttpDelegationHandler : DelegatingHandler
{
